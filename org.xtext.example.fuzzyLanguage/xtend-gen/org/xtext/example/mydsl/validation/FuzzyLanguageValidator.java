    ...
    if (_tripleNotEquals) {
      ...
      if (_equals) {
        ...
        if (_tripleNotEquals_1) {
          this.error("Gaussian function requires 2 parameters : center:T and stddev:T", 
      ...
      if (_equals_1) {
        ...
        if (_tripleNotEquals_2) {
          ...
          _builder.append("Ramp function requires 3 parameters : min:");
          _builder.append(this.type);
          _builder.append(", max:");
          _builder.append(this.type);
          _builder.append(" and direction");
          this.error(_builder.toString(), 
            FuzzyLanguagePackage.Literals.AFFECTATION__VALUE);
          return;
        }
        if (((!a.getParams().get(2).getValue().equals("Up")) && (!a.getParams().get(2).getValue().equals("Down")))) {
          this.error("The third parameter has to be a direction : Up or Down", FuzzyLanguagePackage.Literals.AFFECTATION__VALUE);
          return;
        }
      }
      ...
      if (_equals_2) {
        ...
        if (_tripleNotEquals_3) {
          ...
          _builder_1.append("Triangle function requires 3 parameters : min:");
          _builder_1.append(this.type);
          _builder_1.append(" , mid:");
          _builder_1.append(this.type);
          _builder_1.append("  and max:");
          _builder_1.append(this.type);
          _builder_1.append(" ");
      ...
      if (_equals_3) {
        ...
        if (_tripleNotEquals_4) {
          ...
          _builder_2.append("Trapeze function requires 5 parameters : min:");
          _builder_2.append(this.type);
          _builder_2.append(" , left:");
          _builder_2.append(this.type);
          _builder_2.append(" , right:");
          _builder_2.append(this.type);
          _builder_2.append(" , max:");
          _builder_2.append(this.type);
          _builder_2.append("  and concavity");
          this.error(_builder_2.toString(), 
            FuzzyLanguagePackage.Literals.AFFECTATION__VALUE);
          return;
        }
        if (((!a.getParams().get(4).equals("CONCAVE")) && a.getParams().get(4).equals("CONVEXE"))) {
          this.error("Must be a concavity : CONCAVE or CONVEXE", FuzzyLanguagePackage.Literals.AFFECTATION__PARAMS);
          return;
        }
      }
    }
